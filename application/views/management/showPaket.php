	...
	<div class="row">
		<div class="col-12">
			<div class="page-title-box">
				...
				<h4 class="page-title">Detail Paket Wedding</h4>
			</div>
		</div>
	</div>
			...
			<div class="card d-block">
				<div class="card-body">
					...
					<?php if ($user['role_id'] == 1) : ?>
						<button class="btn btn-info" data-toggle="modal" data-target="#inputModal" data-id="<?= $paket['kd_paket']; ?>" onclick="showPaket('<?= $paket['kd_paket']; ?>')"><i class="mdi mdi-pencil me-1"></i> Edit Paket </button>
					<?php endif; ?>

					<h3 class="mt-3">Nama Paket Wedding</h3>

					<div class="row">
						<div class="col-6">
							<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Paket Wedding</p>
							<div class="d-flex">
						...
						<div class="col-6">
							...
							<div class="d-flex">
								<i class='mdi mdi-cash font-18 text-info me-1'></i>
								<h5 class="mt-1 font-14">
									<?= rupiah($paket['harga']); ?>
								</h5>
							</div>
					...
					<div class="row">
						<div class="col-6">
							<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Jumlah Kru</p>
							<div class="d-flex">
								<iconify-icon class="font-22 text-info me-2" icon="ic:baseline-groups"></iconify-icon>
								<h5 class="mt-1 font-14">
									<?= $paket['kru']; ?>
								</h5>
							</div>
						...
						<div class="col-6">
							<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Harga WO</p>
							<div class="d-flex">
								<i class='mdi mdi-cash font-18 text-info me-1'></i>
								<h5 class="mt-1 font-14">
									<?= rupiah($paket['harga_wo']); ?>
								</h5>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-6">
							<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Dekorasi</p>
							<div class="d-flex">
								<h5 class="mt-1 font-14">
									<?= $paket['dekorasi']; ?>
								</h5>
					...
					<div class="row">
						<div class="col-6">
							<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Busana & Rias Pengantin</p>
							<div class="d-flex">
								<h5 class="mt-1 font-14">
									<?= $paket['brp']; ?>
								</h5>
					...
					<div class="row">
						<div class="col-6">
							<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Catering</p>
							<div class="d-flex">
								<h5 class="mt-1 font-14">
									<?= $paket['catering']; ?>
								</h5>
					...
					<div class="row">
						<div class="col-6">
							<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Dokumentasi</p>
							<div class="d-flex">
								<h5 class="mt-1 font-14">
									<?= $paket['dokumentasi']; ?>
								</h5>
						...
						<div class="col-6">
							...
							<div class="d-flex">
								<i class='mdi mdi-cash font-18 text-info me-1'></i>
								<h5 class="mt-1 font-14">
									<?= rupiah($paket['harga_dokumentasi']); ?>
								</h5>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-6">
							<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Akomodasi & Hiburan</p>
							<div class="d-flex">
								<h5 class="mt-1 font-14">
									<?= $paket['ah']; ?>
								</h5>
						...
						<div class="col-6">
							...
							<div class="d-flex">
								<i class='mdi mdi-cash font-18 text-info me-1'></i>
								<h5 class="mt-1 font-14">
									<?= rupiah($paket['harga_ah']); ?>
								</h5>
							</div>
						</div>
					</div>

					<p class="mt-2 mb-1 text-muted fw-bold font-12 text-uppercase">Jumlah Tamu</p>
					<div class="d-flex">
						<iconify-icon class="font-22 text-info me-2" icon="ic:baseline-groups"></iconify-icon>
						<h5 class="mt-1 font-14">
							<?= angkaa($paket['jumlah_tamu']); ?> - <?= angkaa($paket['jumlah_tamu2']); ?>
						</h5>
					</div>
