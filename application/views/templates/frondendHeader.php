	...
	<?php if ($title == "Home") : ?>
		...
		<?php else : ?>
			...
			<div class="container d-flex align-items-center">
				...
				<button class="get-started-btn scrollto font-weight-bold text-white border-0 btn-danger" data-toggle="modal" data-target="#tambahModal" data-id="" onclick="inputDataBaruFormPelanggan()"><i class='bx bx-copy-alt'></i> Mulai</button>
